...
# Advanced/default/choices metadata for messaging env vars lives in
# hermes_cli/messaging_env_meta.py so the `hermes setup gateway` CLI wizard and
# these dashboard/Desktop forms agree on which knobs are optional and what
# Hermes does when they're left blank.
from hermes_cli.messaging_env_meta import (  # noqa: E402
    messaging_env_ui_hints as _messaging_env_ui_hints,
)
